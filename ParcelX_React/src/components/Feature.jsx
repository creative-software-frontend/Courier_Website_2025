          ...
          <div className={"accordion__container grid grid-3"}>
            ...
            <div className={"accordion"}>
              ...
              <div className={"accordion-content"}>
                <p>
                ParcelX gives you the opportunity of unlimited pickup.
            ...
            <div className={"accordion"}>
              ...
              <div className={"accordion-content"}>
                <p>
                ParcelX provides an unique tracking code for your
            ...
            <div className={"accordion"}>
              ...
              <div className={"accordion-content"}>
                <p>
                  At ParcelX you can request for your payment every
